...
DATA_TRAIN = os.path.join(DATA_FOLDER, 'train_2016_v2.csv')
DATA_PROP = os.path.join(DATA_FOLDER, 'properties_2016.csv')
DATA_TEST = os.path.join(DATA_FOLDER, 'sample_submission.csv')

# define ID and output variable
DATA_ID = 'parcelid'
DATA_OUT_FEATURE = 'logerror'
